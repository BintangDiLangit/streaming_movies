@extends('admin.partials.index-no-layout')

@section('head')
<title>Candu Movie | Sign Up</title>
@endsection
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navigation">
      ...
      <li class="nav-item d-flex align-items-center">
        <a class="btn btn-round btn-sm mb-0 btn-outline-white me-2" href="https://www.creative-tim.com/builder?ref=navbar-soft-ui-dashboard">Watch now</a>
      </li>
      @if(auth()->check())
      <ul class="navbar-nav d-lg-block d-none">
        <li class="nav-item">
          <a href="{{ route('auth.sign-out') }}" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-light">Logout</a>
        </li>
      </ul>
      @else
      <ul class="navbar-nav d-lg-block d-none">
        <li class="nav-item">
          <a href="{{ route('auth.sign-up.index') }}" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-light">Sign-up</a>
        </li>
      </ul>
      @endif
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Lets sign up for free, and enjoy your time with watch tour favorite film.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row mt-lg-n10 mt-md-n11 mt-n10">
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" action="{{ route('auth.sign-up.store') }}" method="post">
                @csrf
                <div class="mb-3">
                ...
                @if(!auth()->check())
                    ...
                    <button type="sumit" class="btn bg-gradient-dark w-100 my-4 mb-2">Sign up</button>
                    </div>
                @endif
                <p class="text-sm mt-3 mb-0">Already have an account? <a href="{{ route('auth.sign-in.index') }}" class="text-dark font-weight-bolder">Sign in</a></p>
              </form>
            </div>
          </div>
        </div>
